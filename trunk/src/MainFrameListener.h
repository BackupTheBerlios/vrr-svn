...
class CMainFrameListener: public FrameListener, public KeyListener
{
protected:
...
public:
    ...
    CMainFrameListener(RenderWindow* win, Camera* cam, bool useBufferedInputKeys = false, bool useBufferedInputMouse = false)
    {
    ...
    virtual bool processUnbufferedKeyInput(const FrameEvent& evt)
    {
		...
		if (mInputDevice->isKeyDown(KC_R) && mTimeUntilNextToggle <=0)
		{
			...
			// FIXME Ocorreu um erro ao mudar a versão do OGRE3D
